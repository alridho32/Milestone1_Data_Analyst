...
[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/ub0qXoTt)
...
9. Untuk `Statistik Deskriptif`, pilihlah minimal salah satu perhitungan/analisis statistik deskriptif seperti _central tendency_, _measure of variance_, _outlier analysis_, _distribution_, dsb. `Sesuaikan dengan penjabaran masalah yang ditentukan`.
...
2. Notebook harus mengikuti format berikut:
   ...
   3. Data Loading
      ...
      > Bagian ini berisi proses _data loading_ dan eksplorasi data sederhana. Cantumkan query SQL masing-masing data yang di-load jika menggunakan dari BigQuery atau server SQL lainnya. Tampilkan juga datanya.
